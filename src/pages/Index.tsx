...
const Index = () => {
  ...
  const products: Record<Category, Product[]> = {
    keychains: [
      ...
      { 
        id: 10, 
        name: 'Брелок "Joost Klein — Europapa"', 
        price: '310 ₽', 
        ...
        description: 'Тематический брелок по мотивам Joost Klein — Europapa! В дизайне использованы синие и голубые бусины, буквы с именем артиста, металлические подвески: звёзды, ракушка, спираль. Базовая длина 17 см с регулируемой цепочкой для идеальной посадки. Идеален для фанатов!',
