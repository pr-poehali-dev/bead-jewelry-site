  ...
  const products: Record<Category, Product[]> = {
    ...
    bracelets: [
      ...
      { 
        ...
        description: 'Нежный браслет с белыми бусинами, сиреневыми акцентами и металлическими подвесками в виде цветка, луны и звёздочки. Базовая длина 17 см с регулируемой цепочкой для идеальной посадки.',
        materials: ['Белые бусины', 'Сиреневые акриловые элементы', 'Металлические подвески', 'Цепочка-удлинитель', 'Застёжка-карабин']
      },
      { 
        id: 6, 
        ...
        description: 'Воздушный браслет в пастельных тонах с белым цветком, зелёными и розовыми звёздочками, жемчужными и прозрачными гранёными бусинами. Базовая длина 17 см, регулируется цепочкой под любой размер руки.',
        materials: ['Акриловые цветы и звёзды', 'Розовый кварц', 'Жемчужные бусины', 'Гранёные прозрачные бусины', 'Цепочка-удлинитель']
      },
      { 
        id: 10, 
        ...
        description: 'Тематический браслет по мотивам Joost Klein — Europapa! В дизайне использованы синие и голубые бусины, буквы с именем артиста, металлические подвески: звёзды, ракушка, спираль. Базовая длина 17 см с регулируемой цепочкой для идеальной посадки. Идеален для фанатов!',
            ...
            >
              <CardContent className="p-0">
                <img
                  src={product.image}
                  alt={product.name}
                  className={`w-full h-64 object-cover ${product.id === 10 ? 'object-[center_30%]' : ''}`}
                />
              </CardContent>
              <CardFooter className="flex flex-col items-center gap-3 p-6">
                <h3 className="text-xl font-semibold">{product.name}</h3>
