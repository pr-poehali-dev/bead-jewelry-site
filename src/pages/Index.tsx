    ...
    keychains: [
      ...
      { 
        ...
        images: [
          ...
          'https://cdn.poehali.dev/files/07e354d5-8fd7-46b9-894c-05cad2a8be63.jpg'
        ],
        description: 'Парные брелки на вощеной нити: зеленый и розовый с прозрачными бантиками, жемчужными бусинами и металлическими подвесками-звездочками. Можно сделать парными или даже распечатать и добавить фото! (Акриловые котики в стоимость не входят). Цена за штуку. С другим карабином будет 270 ₽.',
        materials: ['Прозрачный бантик', 'Вощеная нить', 'Жемчужные бусины', 'Гранёные бусины (зеленые/розовые)', 'Металлические подвески-звёзды', 'Карабин на выбор']
      },
      { 
        id: 21, 
        ...
        description: 'Очаровательный брелок в кремово-карамельной гамме с главным элементом — полимерным круассаном. Украшен жемчужными и персиковыми бусинами, прозрачными гранёными элементами и металлическими подвесками. Три цепочки создают воздушную композицию. Крепится на карабин-звезду. С другим карабином будет 270 ₽.',
        materials: ['Полимерный круассан', 'Жемчужные бусины', 'Персиковые стеклянные бусины', 'Прозрачные гранёные бусины', 'Металлические подвески (спираль, цветок)', 'Тройная цепочка', 'Карабин на выбор']
      },
      { 
        id: 11, 
