  ...
  const products: Record<Category, Product[]> = {
    keychains: [
      ...
      { 
        ...
        price: '550 ₽', 
        image: 'https://cdn.poehali.dev/files/4d97c3e7-d196-417e-b2b4-4f22fccd9944.png',
        images: [
      ...
      { 
        ...
        description: 'Очаровательный брелочек с акриловой рыбкой в нежно-розовых и сиреневых оттенках. Украшен матовыми бусинами, бильярдным шариком "8" и цветочными элементами. Яркий и необычный аксессуар для любителей уникальных вещей.',
        materials: ['Акриловая рыбка', 'Матовые бусины', 'Акриловые элементы', 'Металлическая фурнитура', 'Вощеная нить']
      },
    ],
    bracelets: [
      { 
