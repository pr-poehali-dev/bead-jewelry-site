  ...
  const products: Record<Category, Product[]> = {
    keychains: [
      ...
      { 
        ...
        price: '300 ₽', 
        image: 'https://cdn.poehali.dev/files/f2bc712b-ea29-47ea-9613-fe9bfb5fcf66.jpg',
        images: [
          'https://cdn.poehali.dev/files/f2bc712b-ea29-47ea-9613-fe9bfb5fcf66.jpg',
          'https://cdn.poehali.dev/files/eb0711c1-5f86-45e6-ae7c-0bdc24dd4c29.png'
        ],
        description: 'Стильный брелок с прозрачным перламутровым бантиком, разноцветными бусинами и тремя цепочками с подвесками. Украшен металлическими звездочками, цветочками и спиралями. Крепится на карабин-сердце. Нежный дизайн с пастельными оттенками. С другим карабином будет 270 ₽.',
        materials: ['Карабин-сердце', 'Металлические цепочки', 'Розовые бусины', 'Жемчужные бусины', 'Прозрачные гранёные бусины', 'Металлические подвески', 'Карабин на выбор']
      },
      { 
        id: 22, 
        name: 'Брелок "Красно-черный контраст"', 
        price: '300 ₽', 
        ...
        description: 'Стильный брелок на шнуре для телефона, украшенный красными и черными гранёными бусинами и металлическими подвесками в виде крестика и звездочек. Выразительный акцент для любого образа.',
        materials: ['Стеклянные бусины', 'Акриловые бусины', 'Металлические подвески (крестик, звёзды)', 'Шнур для телефона']
      },
      { 
        id: 23, 
        name: 'Брелок "Пастельная мечта"', 
        price: '175 ₽', 
        ...
        description: 'Стильный брелок с прозрачным перламутровым бантиком, разноцветными бусинами и тремя цепочками с подвесками. Украшен металлическими звездочками, цветочками и спиралями. Крепится на карабин-сердце. Нежный дизайн с пастельными оттенками.',
        materials: ['Прозрачный перламутровый бантик', 'Пастельные бусины (розовые, мятные, сиреневые)', 'Гранёные прозрачные бусины', 'Металлические подвески (звёзды, цветы, спираль)', 'Тройная цепочка', 'Карабин-сердце']
      },
    ],
    bracelets: [
      { 
