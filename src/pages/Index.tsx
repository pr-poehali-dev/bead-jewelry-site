...
const Index = () => {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: 'Все украшения изготовлены вручную из качественных материалов: чешский бисер, жемчужные и стеклянные бусины, натуральные камни (розовый кварц), гипоаллергенная фурнитура из хирургической стали и позолоченных элементов.',
    },
  ];
