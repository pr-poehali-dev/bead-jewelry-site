  ...
  const products: Record<Category, Product[]> = {
    ...
    necklaces: [
      { 
        ...
        description: 'Элегантное ожерелье с белыми и розовыми акриловыми бусинами, стеклянными элементами и металлической подвеской-сердечком с переливающимся кристаллом. Нежный романтичный образ. ✨ Вторая фотография — образец стиля с Pinterest для вдохновения.',
        materials: ['Акриловые бусины', 'Стеклянные элементы', 'Металлическая фурнитура', 'Подвеска-сердце', 'Переливающиеся кристаллы']
      },
      { 
        id: 11, 
        ...
        description: 'Изящное ожерелье на тонкой серебристой цепочке с жемчужными бусинами, звёздочками и бантиком в центре. 💫 Фото с Pinterest для примера стиля — у меня был повтор этого украшения, но с металлическим бантиком вместо эмалевого. Остальные элементы полностью совпадают.',
        materials: ['Тонкая металлическая цепочка', 'Жемчужные бусины', 'Металлические звёздочки', 'Металлический бант', 'Миниатюрные жемчужинки']
      },
    ],
  };
