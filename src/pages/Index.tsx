...
const Index = () => {
  ...
  const products: Record<Category, Product[]> = {
    keychains: [
      ...
      { 
        id: 23, 
        name: 'Брелок "Нежность пастели" (парный к "Дерзкая элегантность")', 
        price: '300 ₽', 
      ...
      { 
        id: 22, 
        name: 'Брелок "Дерзкая элегантность" (парный к "Нежность пастели")', 
        price: '175 ₽', 
        ...
        description: 'Стильный брелок на шнуре для телефона, украшенный красными и черными гранёными бусинами и металлическими подвесками в виде крестика и звездочек. Выразительный акцент для любого образа. Парный к брелку "Нежность пастели" — один нежный пастельный, другой дерзкий и утонченный.',
