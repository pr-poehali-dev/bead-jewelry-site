  ...
  const products: Record<Category, Product[]> = {
    keychains: [
      ...
      { 
        ...
        description: 'Нежный брелочек на карабине в форме сердца с ангельскими крыльями, подвесками в виде звёздочек, крестика, цветка и других милых элементов. Выполнен в розовых тонах с жемчужными бусинами и бусинами с эффектом битого стекла. Идеальный подарок для тех, кто ценит нежность и романтику.',
        materials: ['Розовые бусины', 'Жемчужные бусины', 'Бусины с эффектом битого стекла', 'Металлические подвески (крылья, звёзды, крестик, цветок)', 'Карабин-сердце']
      },
      { 
        id: 12, 
      ...
      { 
        ...
        description: 'Яркий брелочек на карабине с красными и белыми бусинами, жемчужинами и металлическими подвесками: цветочек и звёздочки. Стильный и выразительный аксессуар.',
        materials: ['Красные гранёные бусины', 'Белые перламутровые бусины', 'Жемчужные бусины', 'Металлические подвески (цветок, звёзды)', 'Металлический карабин']
      },
    ],
    bracelets: [
      { 
      ...
      { 
        ...
        price: '375 ₽ за комплект (браслет 275 ₽, серьги 100 ₽)', 
      ...
      { 
        ...
        description: 'Воздушный браслет с жемчужными бусинами, прозрачными гранёными элементами и нежно-розовыми акриловыми цветочками. Центральный элемент — металлическое сердечко с прозрачным центром. Базовая длина 17 см с регулируемой цепочкой.',
        materials: ['Жемчужные бусины', 'Прозрачные гранёные бусины', 'Розовые акриловые цветочки', 'Металлическое сердечко', 'Цепочка-удлинитель', 'Застёжка-карабин']
      },
    ],
    earrings: [
      { 
      ...
      { 
        ...
        description: 'Нежные серьги-подвески с белыми атласными бантиками и жемчужными сердечками-подвесками. Воздушный и романтичный аксессуар для нежного образа. Швензы из медицинской стали.',
        materials: ['Белые атласные бантики', 'Жемчужные сердечки-подвески', 'Медицинская сталь', 'Швензы-крючки']
      },
    ],
    necklaces: [
      { 
