...
const Index = () => {
  ...
  const products: Record<Category, Product[]> = {
    keychains: [
      ...
      { 
        id: 10, 
        name: 'Брелок на карабине-сердце', 
        price: '280 ₽', 
        ...
        description: 'Нежный брелок на карабине-сердце с тремя металлическими цепочками, украшенными розовыми бусинами, жемчужинами, прозрачными элементами и подвесками в виде сердечек, звёздочек и крылышек. Романтичный и воздушный аксессуар.',
        materials: ['Карабин-сердце', 'Металлические цепочки', 'Розовые бусины', 'Жемчужные бусины', 'Прозрачные гранёные бусины', 'Металлические подвески (сердечки, звёзды, крылышки)']
      },
      { 
        id: 22, 
        name: 'Брелок с красно-черными цепочками', 
        price: '300 ₽', 
        ...
        description: 'Стильный брелок на шнуре для телефона с двумя металлическими цепочками, украшенными красными и черными гранёными бусинами, жемчужинами и металлическими подвесками в виде крестика и звездочек. Выразительный акцент для любого образа. С другим карабином будет 270 ₽.',
        materials: ['Красные гранёные бусины', 'Черные бусины', 'Жемчужные бусины', 'Прозрачные бусины', 'Металлические подвески (крестик, звёзды)', 'Шнур для телефона', 'Карабин на выбор']
      },
      { 
        id: 23, 
        name: 'Брелок лаконичный розовый', 
        price: '175 ₽', 
        image: 'https://cdn.poehali.dev/files/7e66f884-bc35-41cc-82c8-6eda5978a43a.png',
        images: ['https://cdn.poehali.dev/files/7e66f884-bc35-41cc-82c8-6eda5978a43a.png'],
        description: 'Лаконичный брелок на шнуре для телефона с нежными розовыми и жемчужными бусинами, дополненный металлическими подвесками в виде звездочек, бантика и жемчужной капли. Минималистичный и нежный аксессуар.',
        materials: ['Розовые бусины', 'Жемчужные бусины', 'Металлические подвески (звездочки, бантик)', 'Жемчужная капля', 'Шнур для телефона']
      },
    ],
    bracelets: [
      { 
