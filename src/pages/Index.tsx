  ...
  const products: Record<Category, Product[]> = {
    keychains: [
      ...
      { 
        ...
        price: '300 ₽', 
        image: 'https://cdn.poehali.dev/files/e530c398-4207-4ada-ae56-4264ccbc124c.png',
        images: [
          'https://cdn.poehali.dev/files/e530c398-4207-4ada-ae56-4264ccbc124c.png',
          'https://cdn.poehali.dev/files/7d0711cb-ca1d-4b06-9418-c560ff60ff24.png',
          'https://cdn.poehali.dev/files/9f2ffd95-7896-44c7-8092-86266c65a746.png'
        ],
      ...
      { 
        ...
        description: 'Очаровательный брелок в кремово-карамельной гамме с главным элементом — полимерным круассаном. Украшен жемчужными и персиковыми бусинами, прозрачными гранёными элементами и металлическими подвесками. Три цепочки создают воздушную композицию. Крепится на карабин-звезду.',
        materials: ['Полимерный круассан', 'Жемчужные бусины', 'Персиковые стеклянные бусины', 'Прозрачные гранёные бусины', 'Металлические подвески (спираль, цветок)', 'Тройная цепочка', 'Карабин-звезда']
      },
    ],
    bracelets: [
      { 
